...
for k in range(1, 11):
   ...
   for x in range(401, 551):
      ...
      if str(Predict) == str(True_Label):
         Correct += 1
   print("K =", y, "-->",  Correct / 150 * 100 , "% correct ")
...
Test = [ np.array([77.33333333333333, 77.33333333333333, 74.66666666666667, 74.0, 72.0, 71.33333333333334, 66.66666666666666, 65.33333333333333, 59.333333333333336, 58.666666666666664]),
         np.array([80.0, 80.0, 71.33333333333334, 72.0, 68.66666666666667, 69.33333333333334, 64.0, 65.33333333333333, 63.33333333333333, 64.66666666666666]),
         np.array([74.66666666666667, 74.66666666666667, 73.33333333333333, 69.33333333333334, 66.66666666666666, 67.33333333333333, 63.33333333333333, 63.33333333333333, 63.33333333333333, 62.66666666666667]),
         np.array([70.66666666666667, 70.66666666666667, 67.33333333333333, 68.0, 62.0, 63.33333333333333, 60.0, 60.66666666666667, 57.99999999999999, 58.666666666666664]),
         np.array([84.66666666666667, 84.66666666666667, 74.0, 77.33333333333333, 71.33333333333334, 67.33333333333333, 64.0, 61.33333333333333, 60.66666666666667, 58.666666666666664]),
         np.array([72.0, 72.0, 69.33333333333334, 68.0, 64.0, 64.0, 60.0, 61.33333333333333, 57.99999999999999, 59.333333333333336]),
         np.array([78.0, 78.0, 70.0, 70.0, 66.0, 62.0, 60.0, 57.99999999999999, 59.333333333333336, 56.666666666666664]),
         np.array([73.33333333333333, 73.33333333333333, 72.66666666666667, 70.66666666666667, 72.0, 70.66666666666667, 66.0, 64.0, 64.0, 60.66666666666667]),
         np.array([78.66666666666666, 78.66666666666666, 73.33333333333333, 70.66666666666667, 65.33333333333333, 65.33333333333333, 64.0, 61.33333333333333, 60.66666666666667, 57.99999999999999]),
         np.array([76.66666666666667, 76.66666666666667, 70.66666666666667, 70.66666666666667, 62.66666666666667, 62.66666666666667, 61.33333333333333, 62.66666666666667, 61.33333333333333, 62.0])
        ]
